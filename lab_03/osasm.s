...
SysTick_Handler					; 1) Saves R0-R3,R12,LR,PC,PSR
	...
	PUSH	{R0,LR}				; 5) Save R0 and Link Regiester since we are gona call a function
    BL		Scheduler			; 6) Call Scheduler function
	POP		{R0, LR}			; 7) Pop all registers
